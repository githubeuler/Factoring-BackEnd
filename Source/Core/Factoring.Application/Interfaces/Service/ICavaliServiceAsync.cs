...
namespace Factoring.Application.Interfaces.Service
{
    ...
    {
        Task<CavaliAuthResponseDto> AuthenticationApi();
        Task<ResponseCavaliInvoice4012> SendInvoice4012(InvoiceRoot invoiceRoot, InvoiceRoot2 invoiceRoot2, string token);
        Task<ResponseCavaliInvoice4012> SendInvoice4012Holder(InvoiceRootHolder invoiceRoot, InvoiceRoot2 invoiceRoot2, string token);
